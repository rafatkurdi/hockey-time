...
@Component({
  selector: 'app-cross-ice-pass-shot-saved',
  templateUrl: './cross-ice-pass-shot-saved.component.html',
  styleUrls: ['./cross-ice-pass-shot-saved.component.scss']
})
export class CrossIcePassShotSavedComponent implements OnInit {

  @Output() saveToPlaylist = new EventEmitter<CommonObject>();
  @Output() playCrossIcePassShotsSaved = new EventEmitter<VideToPlay[]>();
  ...
  playOne(goal: CommonObject) {
    ...
    this.playCrossIcePassShotsSaved.emit(video);
  }
}
