...
@Component({
  selector: 'app-odd-man-rushes-saved',
  templateUrl: './odd-man-rushes-saved.component.html',
  styleUrls: ['./odd-man-rushes-saved.component.scss']
})
export class OddManRushesSavedComponent implements OnInit {

  @Output() saveToPlaylist = new EventEmitter<CommonObject>();
  @Output() playOddManRushesSaved = new EventEmitter<VideToPlay[]>();
  ...
  playOne(goal: CommonObject) {
    ...
    this.playOddManRushesSaved.emit(video);
  }
}
